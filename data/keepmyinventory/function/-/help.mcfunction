...
data modify storage six:in sourced_message.lines append value {text:"", color:aqua, extra:[{text:" "}, {text:"keepmyinventory.let_vanish", color:green}, {text:" - ", color:gray}, {text:"Makes "}, {text:"keepmyinventory.items", color:dark_aqua}, {text:" ignore vanishing items."}]}
