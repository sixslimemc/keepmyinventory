...
data modify storage six:in sourced_message.lines append value {text:"", color:aqua, extra:[{text:" "}, {text:"keepmyinventory.drop_vanish", color:green}, {text:" - ", color:gray}, {text:"Drop vanishing items on death (regardless of "}, {text:"keepmyinventory.items", color:dark_aqua}, {text:")."}]}
