...
data modify storage six:in sourced_message.lines append value {text:"", color:aqua, extra:[{text:" "}, {text:"keepmyinventory.let_vanish", color:yellow}, {text:" - ", color:gray}, {text:"Modifies "}, {text:"keepmyinventory.items", color:dark_aqua}, {text:" to ignore vanishing items."}]}
data modify storage six:in sourced_message.lines append value {text:"", color:aqua, extra:[{text:" "}, {text:"keepmyinventory.drop_vanish", color:yellow}, {text:" - ", color:gray}, {text:"Items that would vanish are always dropped instead."}]}
data modify storage six:in sourced_message.lines append value {text:""}
data modify storage six:in sourced_message.lines append value {text:"", color:gray, extra:[{text:"/tag "}, {text:"<player>", color:blue}, {text:" add "}, {text:"<tag>", color:yellow}]}
