...
data modify storage six:in sourced_message.lines append value {text:"", color:aqua, extra:[{text:" "}, {text:"keepmyinventory.let_vanish", color:green}, {text:" - ", color:gray}, {text:"Modifies "}, {text:"keepmyinventory.items", color:dark_aqua}, {text:" to ignore vanishing items."}]}
data modify storage six:in sourced_message.lines append value {text:"", color:aqua, extra:[{text:" "}, {text:"keepmyinventory.drop_vanish", color:green}, {text:" - ", color:gray}, {text:"Items that would vanish are always dropped instead."}]}
